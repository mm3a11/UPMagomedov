...
public partial class EnvironmentalMonitoringContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=44-5;Database=EnvironmentalMonitoring;TrustServerCertificate=True;Integrated Security=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Location>(entity =>
        {
            entity.HasKey(e => e.LocationId).HasName("PK__Location__E7FEA477EEFE74A9");
        ...
        {
            entity.HasKey(e => e.SensorId).HasName("PK__Sensors__D809841AE2E207AE");
        ...
        {
            entity.HasKey(e => e.StandardId).HasName("PK__Standard__BB33D3ECEC9B279B");
